...
// 触发 ctx.betterSidebar 类型合并（结构性本地声明，纯类型、打包时擦除）。
import type {} from './better-sidebar.ts'
import { QianxunTab } from './QianxunTab.tsx'
import { QianxunDetailTab } from './QianxunDetailTab.tsx'
import { PromptEditTab } from './PromptEditTab.tsx'
