...
export const MARGIN_TIERS: ReadonlyArray<{
  threshold: number
  label: string
  description: string
}> = [
...
export const PROD_FRESH_FIELDS: ReadonlyArray<{ field: string; note: string }> = [
...
export const PROD_DEAD_ZONE_FIELDS: ReadonlyArray<{ field: string; note: string }> = [
